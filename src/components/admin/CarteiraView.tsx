            ...
            {resultadoEfi && (
              <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl space-y-3">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-3 text-[11px]">
                  ...
                  <div className="p-2.5 bg-slate-900 rounded-lg border border-slate-800/60">
                    <span className="text-slate-500 block">Saldo Real Efí:</span>
                    <strong className="text-emerald-400 block truncate">
                      {resultadoEfi.saldoReal !== undefined ? `R$ ${resultadoEfi.saldoReal.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` : 'Indisponível'}
                    </strong>
                  </div>
                </div>
